...
gem 'devise', '4.7.2' # Authentication framework
gem 'devise-jwt', '0.6.0' # JWT authentication for native Primero users
...
gem 'minipack', '~> 0.3', '>= 0.3.6' # An alternative to Webpacker. TODO: Is this still needed? In prod?
